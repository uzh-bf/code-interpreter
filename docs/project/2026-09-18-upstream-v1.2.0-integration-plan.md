...
Status: executing under the fork's upstream-tracking program; merge into
`main` and every other gated action stay separately approved.
...
Separately gated (asked at the end, not executed): merge into `main`;
closing dependabot PRs #4/#14/#16 (superseded after v1.1.0); PR #21
disposition; deleting merged branches or worktrees; image publication; any
